...
public class Time {
	...
	public Time(int hh, int mm, int ss, int dd, int MM, int YY)
		...
		if ((hh < 0) || (hh > 24) || (mm < 0) || (mm > 60) || (ss < 0)
				|| (ss > 60) || (dd < 0) || (dd > 31) || (MM < 0) || (MM > 12)
				|| (YY < 0)) {
			throw new IllegalArgumentException(
					"One or more date fields is invalid.");
		}
		this.hh = hh;
		this.mm = mm;
		this.ss = ss;
	...
	public String toString() {
		return new String(hh + ":" + mm + ":" + ss + " " + dd + "." + MM + "."
				+ YY);
	}

	public static Time now() throws IllegalArgumentException {
